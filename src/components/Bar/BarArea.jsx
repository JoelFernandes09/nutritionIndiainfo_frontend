...
export const BarArea = ({graphTitle,graphTimeperiod, graphUnit,selIndiaData,level,selArea,titleAreaName,sel_area_names, areaName,selStateData, toggleStateBurden, selLifecycle,selCategory,selIndicator, indicatorTitle, timeperiodName}) => {
