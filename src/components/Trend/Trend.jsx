...
export const Trend = ({indicatorTrend, graphTitle, graphUnit, titleAreaName, toggleStateBurden,selLifecycle,selCategory,selIndicator,note, indicatorTitle, timeperiodName}) => { 
      ...
      <FullScreen  className="w-full bg-white h-full" handle={screen} onChange={reportChange}>
        <div className='static relative w-full h-full'>
          ...
          <div className='relative w-full h-full pb-3 pt-1 pr-3' id="svgTrend" ref={componentRef}>
            <div className="text-center absolute right-5 left-5 mx-10 w-auto  font-bold  text-xs md:text-sm my-trend-title">{title}</div>
